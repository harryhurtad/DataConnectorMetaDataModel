 ...
 */
package com.dataconnector.compiler;
...
public class Javac {
     ...
     */
    public void compile(String srcFiles[]) throws CompilerDataConnectorException {
        ...
        if(resultCode!=0){
          throw  new CompilerDataConnectorException(err.toString());
        }
        
       
    }

    public void compile(File srcFiles[]) throws CompilerDataConnectorException {
